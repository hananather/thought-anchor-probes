...
| pytest | 0 | 29.47 | `02_pytest.log` | `/workspace/thought-anchor-probes/.venv/bin/python -m pytest -q` |
| run_experiments | 1 | 27.16 | `03_run_experiments.log` | `/workspace/thought-anchor-probes/.venv/bin/python scripts/run_experiments.py --config configs/experiment.yaml --pilot-config configs/experiment_pilot.yaml --full-config configs/experiment_full.yaml --problem-id 330 --readme-path README.md` |
...
## Disk Usage
- `du -sh artifacts/`: 224M	artifacts
